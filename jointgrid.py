...
class JointPlot(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent=None, x=None, y=None, x_outlier=None, y_outlier=None,
                 df_without_nan=None, column_name1=None, column_name2=None, r=None, r_w=None):
...
class jointgridWindow(QtWidgets.QWidget):
    ...
    def on_pushButton_clicked(self):
        ...
        if len(self.selected_items) == self.num_of_selected_items:
            ...
            dialog = JointPlot(self, x=x, y=y, x_outlier=x_outlier, y_outlier=y_outlier, df_without_nan=df_without_nan,
